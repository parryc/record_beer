...
def upgrade():
    op.add_column(
        "users", sa.Column("default_drink_date", sa.DateTime(), nullable=True)
    )
    op.add_column(
        "users", sa.Column("default_drink_location_city", sa.Text(), nullable=True)
    )
    op.add_column(
        "users", sa.Column("default_drink_location_country", sa.Text(), nullable=True)
    )
